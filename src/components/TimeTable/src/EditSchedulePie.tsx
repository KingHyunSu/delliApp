...
const EditSchedulePie = ({data, homeTopHeight, scheduleList, x, y, radius, onChangeSchedule}: Props) => {
  ...
  return (
    <G>
      <SchedulePie data={data} x={x} y={y} radius={radius} startAngle={editStartAngle} endAngle={editEndAngle} />
