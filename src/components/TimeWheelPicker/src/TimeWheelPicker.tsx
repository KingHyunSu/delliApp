...
import WheelPickerItem from './TimeWheelPickerItem'
...
const TimeWheelPicker = forwardRef<Refs, Props>(
  (
    {
      selectedIndex,
      options,
    ...
    const handleScroll = Animated.event([{nativeEvent: {contentOffset: {y: scrollY}}}], {
      listener: (scrollEvent: NativeSyntheticEvent<NativeScrollEvent>) => {
        handleMomentumScrollEnd(scrollEvent)
      },
