...
const DayOfWeekPanel = ({
  ...
  }, [data.mon, data.tue, data.wed, data.thu, data.fri, data.sat, data.sun, getDayOfWeekTitleStyle])

  const contentsComponent = React.useMemo(() => {
    return (
    ...
    data.sat,
    data.sun,
    getDayOfWeekSelectButtonStyle,
    getDayOfWeekSelectButtonTextStyle,
    _changeDayOfWeek
  ])
